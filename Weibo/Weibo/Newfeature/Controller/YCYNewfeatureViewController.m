...
#define YCYNewfeatureCount 4

@interface YCYNewfeatureViewController () <UIScrollViewDelegate>
@property (nonatomic, weak) UIPageControl *pageControl;

@property (nonatomic, weak) UIScrollView *scrollView;
@end

@implementation YCYNewfeatureViewController
...
- (void)viewDidLoad
{
    ...
    for (int i = 0; i<YCYNewfeatureCount; i++) {
    ...
    pageControl.numberOfPages = YCYNewfeatureCount;
    pageControl.backgroundColor = [UIColor redColor];
    pageControl.currentPageIndicatorTintColor = YCYColor(253, 98, 42);
    pageControl.pageIndicatorTintColor = YCYColor(189, 189, 189);
